...
namespace Neural
{
	...
	/// etc..
	/// </summary>
	public class InvalidInputsException : System.Exception
	{
		/// <summary>
		/// Create a new invalid inputs exception.
		/// </summary>
		public InvalidInputsException() : base()
		{
			//
		...
		public InvalidInputsException(string message, System.Exception excp) : base(message, excp)
		{
