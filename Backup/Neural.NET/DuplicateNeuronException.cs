...
namespace Neural
{
	...
	/// </summary>
	public class DuplicateNeuronException : System.Exception
	{
		/// <summary>
		/// Default constructor.
		/// </summary>
		public DuplicateNeuronException() : base()
		{
			//
		...
		public DuplicateNeuronException(string message) : base(message)
		{
		...
		public DuplicateNeuronException(string message, Exception excp) : base(message, excp)
		{
